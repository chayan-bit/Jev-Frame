...
```sh
pip install "jev-frame @ git+https://github.com/chayan-bit/Jev-Frame@v0.2.0" # x-release-please-version
```

Optional integrations are available as extras:

```sh
pip install "jev-frame[langchain] @ git+https://github.com/chayan-bit/Jev-Frame@v0.2.0" # x-release-please-version
pip install "jev-frame[pydantic-ai] @ git+https://github.com/chayan-bit/Jev-Frame@v0.2.0" # x-release-please-version
```
